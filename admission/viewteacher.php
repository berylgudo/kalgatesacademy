...
<div class="main_content nav justify-content-end">
      ...
      <div class="container">
<form class="row g-3" action="viewteacher.php" method="post">
  <div class="col-md-12">
    <label1 class="h3">Search teacher by contact number </label1>
...
<h3>Teacher's Details</h3>
     ...
     if(isset($_POST['search'])){
         ...
         $sql = "SELECT * FROM `teacher` WHERE contact = '$contact'";
         ...
         while($row = mysqli_fetch_array($result)){
            ...
            <tr>
                 ...
                 <td><?php echo "<a href='teacheredit.php?id=".$row['id']."'>";?><i class="btn btn-primary">Edit</i></a></td>
