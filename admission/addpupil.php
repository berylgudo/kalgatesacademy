...
<div class="main_content nav justify-content-end">
      ...
      <div class="container">
<form class="row g-3" action="handleadmissionfiles/handleaddpupil.php" method="post">
  <h1>ADD PUPIL TO SCHOOL DB</h1>
  <div class="col-md-4">
    <label1 class="form-label">Pupil Name</label1>
    <input type="text" name="pupilname" class="form-control">
  </div>
  <div class="col-4">
    <label1 class="form-label">Admission Number</label1>
    <input type="text" name="adm_no" class="form-control"  placeholder="K987">
  </div>
  <div class="col-md-4">
  ...
  <input type="date" class="center" id="inputZip" name="dob" >
  </div>
  <h5>Contact info</h5>
  <div class="col-4">
  ...
  <div class="col-12">
    <button type="submit" name ="submit" class="btn btn-primary">ADD PUPIL</button>
  </div>
</form>
<div>
