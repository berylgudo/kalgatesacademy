...
<div class="main_content nav justify-content-end">
      ...
      <div class="container">
<form class="row g-3" action="viewpupil.php" method="post">
  <div class="col-md-12">
     ...
     if(isset($_POST['search'])){
         ...
         while($row = mysqli_fetch_array($result)){
            ...
            <tr>
                 ...
                 <td><?php echo "<a href='pupiledit.php?id=".$row['id']."'>";?><i class="btn btn-primary">Edit</i></a>
                 <?php echo "<a href='addresultgrd4-grd6.php?id=".$row['id']."'>";?><i class="btn btn-primary">Add Result grd4-6</i></a>
                 <?php echo "<a href='addresultgrd1-3.php?id=".$row['id']."'>";?><i class="btn btn-primary">Add Result grd1-3</i></a>
                 <?php echo "<a href='addresultPP1-2.php?id=".$row['id']."'>";?><i class="btn btn-primary">Add Result PP1-2</i></a>
                 <?php echo "<a href='viewresult.php?id=".$row['id']."'>";?><i class="btn btn-primary">Results</i></a></td>
