...
$total=$english+$maths+$environmental+$hygiene+$kiswahili+$creative+$music+$religion;

    //run the update query
    $sql = "INSERT INTO `result`(`term`, `pupilname`, `grade`, `stream`, `english`, `maths`, `environmental`, `hygiene`, `kiswahili`, `creative`, `music`, `religion`, `total`)
    VALUES ('$term','$pupilname','$grade','$stream','$english','$maths','$environmental','$hygiene','$kiswahili','$creative,'$music','$religion','$total')";
