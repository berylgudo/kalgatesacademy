...
$total=$english+$maths+$environmental+$psychomotor+$creative+$music+$religion;

    //run the update query
    $sql = "INSERT INTO `result`(`term`, `name`, `grade`, `stream`, `english`, `maths`, `environmental`, `psychomotor`, `creative`, `music`, `religion`, `total`)
