...
$amount_paid=$_REQUEST['amount_paid'];
 $balance=$_REQUEST['balance'];
    ...
    $sql = "UPDATE `pupil` SET `total_billed`='$total_billed',`balance`='$balance' WHERE id='$id'";
    ...
    if($result){
        ...
        echo "<div class='alert alert-success' role='alert'>Could Not Update</div>";
    }
...
<div class="main_content nav justify-content-end">
      ...
      <div class="container">
<form class="row g-3" action="editfee.php" method="post" enctype="multipart/form-data">
<div class="col-md-3">
...
<div class="col-md-3">
    ...
    <input type="number" name="total_billed" value="<?php echo $total_billed; ?>" class="form-control">
  </div>
  <div class="col-md-3">
    <label class="form-label">Balance:</label>
    <input type="number" name="balance" value="<?php echo $balance; ?>" class="form-control">
  </div>
  <div class="col-md-12">
